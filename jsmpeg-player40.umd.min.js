    ...
    var k = function() {
        ...
        G = function() {
            ...
            return t.startLoading = function() {
                ...
                // Video only mode - audio ayrı player'dan geliyor
                if (this.video) {
                    ...
                    // Frame rate'e göre video decode et
                    var elapsed = now - this.lastVideoDecodeTime;
                ...
                // Audio varsa (eski mod için uyumluluk)
                if (this.audio && this.audio.canPlay) {
                    var targetBuf = this.options.targetAudioBuffer || 0.5;
                    while (this.audioOut.enqueuedTime < targetBuf) { 
