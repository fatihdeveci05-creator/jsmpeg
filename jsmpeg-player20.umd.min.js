        ...
        G = function() {
            ...
            return t.startLoading = function() {
                ...
                if (this.audio && this.audio.canPlay && this.video) {
                    ...
                    // Buffer overflow kontrolü - 2 saniyeden fazla birikme varsa resetle
                    if (this.audioOut.enqueuedTime > 2) {
                        this.audioOut.resetEnqueuedTime();
                        this.audio.decodedTime = this.video.currentTime;
                        if (this.options.onSyncReset) this.options.onSyncReset({reason: 'buffer_overflow', enqueuedTime: this.audioOut.enqueuedTime});
                    }
