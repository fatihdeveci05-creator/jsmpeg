 ...
 */
! function(A, t) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : (A = "undefined" != typeof globalThis ? globalThis : A || self).JSMpeg = t()
}(this, (function() {
    "use strict";
    ...
    function A() {
        return A = Object.assign ? Object.assign.bind() : function(A) {
            for (var t = 1; t < arguments.length; t++) {
                var i = arguments[t];
                for (var e in i)({}).hasOwnProperty.call(i, e) && (A[e] = i[e])
            }
            return A
    ...
    function t(A, t) {
        A.prototype = Object.create(t.prototype), A.prototype.constructor = A, i(A, t)
    }
    ...
    var e = A => "string" == typeof A && A.constructor === String,
        s = function(A) {
            var t, i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0;
            return t = A, "Promise" === Object.prototype.toString.call(t).slice(8, -1) ? A : new Promise((t => {
                A(), setTimeout(t, i)
            }))
        };
    var I = "WJ3NAvwFY9",
    ...
    ! function(A, t) {
        ...
        if ("undefined" != typeof document) {
            ...
            s.type = "text/css", "top" === i && e.firstChild ? e.insertBefore(s, e.firstChild) : e.appendChild(s), s.styleSheet ? s.styleSheet.cssText = A : s.appendChild(document.createTextNode(A))
        }
    ...
    var C = function() {
            function t(t, i, s, I) {
                ...
                }, I), this.options.needPlayButton = this.options.control && !this.options.picMode, this.player = null, this.els = {
                    wrapper: e(t) ? document.querySelector(t) : t,
                    canvas: null,
                    playButton: document.createElement("div"),
                    unmuteButton: null,
                    poster: null
                }, "static" === window.getComputedStyle(this.els.wrapper).getPropertyValue("position") && (this.els.wrapper.style.position = "relative"), this.els.wrapper.clientRect = this.els.wrapper.getBoundingClientRect(), this.initCanvas(), this.initPlayButton(), this.initPlayer()
            }
            var i = t.prototype;
            return i.initCanvas = function() {
                this.options.canvas ? this.els.canvas = e(this.options.canvas) ? document.querySelector(this.options.canvas) : this.options.canvas : (this.els.canvas = document.createElement("canvas"), this.els.canvas.classList.add(I), this.els.wrapper.appendChild(this.els.canvas))
                ...
                return t ? Promise.resolve().then((function() {
                    return s((function() {
                        A.els.wrapper.style.width = t.width + "px", A.els.wrapper.style.height = t.height + "px"
                    }))
                })) : Promise.resolve()
            }, i.onUnlockAudio = function(A, t) {
                var i = this;
                this.els.unmuteButton && (t.preventDefault(), t.stopPropagation()), this.player.audioOut.unlock((function() {
                    i.els.unmuteButton && i.els.unmuteButton.classList.add(B), A.removeEventListener("touchstart", i.unlockAudioBound), A.removeEventListener("click", i.unlockAudioBound)
                }))
            }, i.onClick = function() {
                ...
                this.play = function() {
                    ...
                    A.player.destroy(), A.els.wrapper.innerHTML = "", A.els.wrapper.playerInstance = null
                }
            }, t
        }(),
        Q = function() {
        ...
        r = function(A) {
            for (var t = window.atob(A), i = t.length, e = new Uint8Array(i), s = 0; s < i; s++) e[s] = t.charCodeAt(s);
            return e.buffer
        },
        n = function() {
            function A(A, t) {
                this.url = A, this.destination = null, this.request = null, this.streaming = !1, this.completed = !1, this.established = !1, this.progress = 0, this.onEstablishedCallback = t.onSourceEstablished, this.onCompletedCallback = t.onSourceCompleted, t.hookOnEstablished && (this.hookOnEstablished = t.hookOnEstablished)
            }
            var t = A.prototype;
            ...
            }, t.resume = function() {}, t.destroy = function() {
                this.request.abort()
            }, t.onProgress = function(A) {
                this.progress = A.loaded / A.total
            }, t.onLoad = function(A) {
                this.established = !0, this.completed = !0, this.progress = 1, this.hookOnEstablished && this.hookOnEstablished(), this.onEstablishedCallback && this.onEstablishedCallback(this), this.onCompletedCallback && this.onCompletedCallback(this), this.destination && this.destination.write(A)
            }, A
        }(),
        h = function() {
            function A(A, t) {
                this.url = A, this.destination = null, this.request = null, this.streaming = !1, this.completed = !1, this.established = !1, this.progress = 0, this.fileSize = 0, this.loadedSize = 0, this.chunkSize = t.chunkSize || 1048576, this.isLoading = !1, this.loadStartTime = 0, this.throttled = !1 !== t.throttled, this.aborted = !1, this.onEstablishedCallback = t.onSourceEstablished, this.onCompletedCallback = t.onSourceCompleted, t.hookOnEstablished && (this.hookOnEstablished = t.hookOnEstablished)
            }
            var t = A.prototype;
            return t.connect = function(A) {
                this.destination = A
                ...
                var A = this;
                this.request = new XMLHttpRequest, this.request.onreadystatechange = function() {
                    A.request.readyState === A.request.DONE && (A.fileSize = parseInt(A.request.getResponseHeader("Content-Length"), 10), A.loadNextChunk())
                }, this.request.onprogress = this.onProgress.bind(this), this.request.open("HEAD", this.url), this.request.send()
            }, t.resume = function(A) {
                ...
                if (t >= this.fileSize || this.aborted) return this.completed = !0, void(this.onCompletedCallback && this.onCompletedCallback(this));
                this.isLoading = !0, this.loadStartTime = Q(), this.request = new XMLHttpRequest, this.request.onreadystatechange = function() {
                ...
                }, 0 === t && (this.request.onprogress = this.onProgress.bind(this)), this.request.open("GET", this.url + "?" + t + "-" + i), this.request.setRequestHeader("Range", "bytes=" + t + "-" + i), this.request.responseType = "arraybuffer", this.request.send()
            }, t.onProgress = function(A) {
                this.progress = A.loaded / A.total
            }, t.onChunkLoad = function(A) {
                var t = !this.established;
                this.established = !0, this.progress = 1, this.loadedSize += A.byteLength, this.loadFails = 0, this.isLoading = !1, t && this.hookOnEstablished && this.hookOnEstablished(), t && this.onEstablishedCallback && this.onEstablishedCallback(this), this.destination && this.destination.write(A), this.loadTime = Q() - this.loadStartTime, this.throttled || this.loadNextChunk()
            }, A
        }(),
        d = function() {
            function A(A, t) {
                this.url = A, this.options = t, this.socket = null, this.streaming = !0, this.callbacks = {
                    connect: [],
                    data: []
                }, this.destination = null, this.reconnectInterval = void 0 !== t.reconnectInterval ? t.reconnectInterval : 5, this.shouldAttemptReconnect = !!this.reconnectInterval, this.completed = !1, this.established = !1, this.progress = 0, this.reconnectTimeoutId = 0, this.onEstablishedCallback = t.onSourceEstablished, this.onCompletedCallback = t.onSourceCompleted, t.hookOnEstablished && (this.hookOnEstablished = t.hookOnEstablished)
            }
            var t = A.prototype;
            return t.connect = function(A) {
                this.destination = A
                ...
                this.shouldAttemptReconnect = !!this.reconnectInterval, this.progress = 0, this.established = !1, this.options.protocols ? this.socket = new WebSocket(this.url, this.options.protocols) : this.socket = new WebSocket(this.url), this.socket.binaryType = "arraybuffer", this.socket.onmessage = this.onMessage.bind(this), this.socket.onopen = this.onOpen.bind(this), this.socket.onerror = this.onClose.bind(this), this.socket.onclose = this.onClose.bind(this)
            }, t.resume = function() {}, t.onOpen = function() {
                this.progress = 1
            }, t.onClose = function() {
                var A = this;
                ...
                var t = !this.established;
                this.established = !0, t && this.hookOnEstablished && this.hookOnEstablished(), t && this.onEstablishedCallback && this.onEstablishedCallback(this), this.destination && this.destination.write(A.data)
            }, A
        }(),
        c = function() {
            function A(t, i) {
                "object" == typeof t ? (this.bytes = t instanceof Uint8Array ? t : new Uint8Array(t), this.byteLength = this.bytes.length) : (this.bytes = new Uint8Array(t || 1048576), this.byteLength = 0), this.mode = i || A.MODE.EXPAND, this.index = 0
            }
            var t = A.prototype;
            return t.resize = function(A) {
                var t = new Uint8Array(A);
                0 !== this.byteLength && (this.byteLength = Math.min(this.byteLength, A), t.set(this.bytes, 0, this.byteLength)), this.bytes = t, this.index = Math.min(this.index, this.byteLength << 3)
            }, t.evict = function(A) {
                var t = this.index >> 3,
                    i = this.bytes.length - this.byteLength;
                if (this.index === this.byteLength << 3 || A > i + t) return this.byteLength = 0, void(this.index = 0);
                0 !== t && (this.bytes.copyWithin ? this.bytes.copyWithin(0, t, this.byteLength) : this.bytes.set(this.bytes.subarray(t, this.byteLength)), this.byteLength -= t, this.index -= t << 3)
            }, t.write = function(t) {
                ...
                A = A instanceof Uint8Array ? A : new Uint8Array(A), this.bytes.set(A, this.byteLength), this.byteLength += A.length
                ...
                for (var t = this.index, i = 0; A;) {
                    var e = 8 - (7 & t),
                        s = e < A ? e : A,
                        I = e - s;
                    i = i << s | (this.bytes[t >> 3] & 255 >> 8 - s << I) >> I, t += s, A -= s
                }
                return i
            }, t.read = function(A) {
                var t = this.peek(A);
    ...
    var l = function() {
        ...
        return t.connect = function(A, t) {
                ...
                if (t && this.bits.nextBytesAreStartCode()) {
                    ...
                    if (Q) {
                        ...
                        if (2 & a) {
                            ...
                            this.bits.skip(1), E = (1073741824 * r + 32768 * n + h) / 9e4, this.currentTime = E, -1 === this.startTime && (this.startTime = E)
                        }
                        var d = g ? g - B - 3 : 0;
            ...
            return A.buffers.push(this.bits.bytes.subarray(t, i)), A.currentLength += i - t, 0 !== A.totalLength && A.currentLength >= A.totalLength
        }, t.packetComplete = function(A) {
            A.destination.write(A.pts, A.buffers), A.totalLength = 0, A.currentLength = 0, A.buffers = []
        }, A
    }();
    l.STREAM = {
        PACK_HEADER: 186,
    ...
    var u = function() {
            function A(A) {
                this.destination = null, this.canPlay = !1, this.collectTimestamps = !A.streaming, this.bytesWritten = 0, this.timestamps = [], this.timestampIndex = 0, this.startTime = 0, this.decodedTime = 0, Object.defineProperty(this, "currentTime", {
                    get: this.getCurrentTime
                })
            }
            var t = A.prototype;
            return t.destroy = function() {}, t.connect = function(A) {
                this.destination = A
                ...
                if (A > 0) { this.lastPTS = A; if (!this.ptsStartTime) this.ptsStartTime = A; }
                this.collectTimestamps && (0 === this.timestamps.length && (this.startTime = A, this.decodedTime = A), this.timestamps.push({
                    index: this.bytesWritten << 3,
                    time: A
                })), this.bytesWritten += this.bufferWrite(t), this.canPlay = !0
            }, t.syncToPTS = function(targetPTS) {
                if (targetPTS > 0 && this.lastPTS) {
                    this.decodedTime = targetPTS;
                    return true;
                }
                return false;
            }, t.seek = function(A) {
                if (this.collectTimestamps) {
                    ...
                    for (var t = 0; t < this.timestamps.length && !(this.timestamps[t].time > A); t++) this.timestampIndex = t;
                    var i = this.timestamps[this.timestampIndex];
                    i ? (this.bufferSetIndex(i.index), this.decodedTime = i.time) : (this.bufferSetIndex(0), this.decodedTime = this.startTime)
                }
            }, t.decode = function() {
                this.advanceDecodedTime(0)
            }, t.advanceDecodedTime = function(A) {
                if (this.collectTimestamps) {
                    for (var t = -1, i = this.bufferGetIndex(), e = this.timestampIndex; e < this.timestamps.length && !(this.timestamps[e].index > i); e++) t = e;
                    if (-1 !== t && t !== this.timestampIndex) return this.timestampIndex = t, void(this.decodedTime = this.timestamps[this.timestampIndex].time)
                }
                this.decodedTime += A
        ...
        w = function(A) {
            function i(t) {
                ...
                return i.bits = new c(e, s), i.customIntraQuantMatrix = new Uint8Array(64), i.customNonIntraQuantMatrix = new Uint8Array(64), i.blockData = new Int32Array(64), i.currentFrame = 0, i.decodeFirstFrame = !1 !== t.decodeFirstFrame, i
            }
            t(i, A);
            var e = i.prototype;
            return e.write = function(A, t) {
                ...
                var A = this.bits.read(12),
                    t = this.bits.read(12);
                if (this.bits.skip(4), this.frameRate = i.PICTURE_RATE[this.bits.read(4)], this.bits.skip(30), A === this.width && t === this.height || (this.width = A, this.height = t, this.initBuffers(), this.destination && this.destination.resize(A, t)), this.bits.read(1)) {
                    for (var e = 0; e < 64; e++) this.customIntraQuantMatrix[i.ZIG_ZAG[e]] = this.bits.read(8);
                ...
                if (this.currentFrame++, this.bits.skip(10), this.pictureType = this.bits.read(3), this.bits.skip(16), !(this.pictureType <= 0 || this.pictureType >= i.PICTURE_TYPE.B)) {
                    ...
                    for (; A >= i.START.SLICE_FIRST && A <= i.START.SLICE_LAST;) this.decodeSlice(255 & A), A = this.bits.findNextStartCode();
                    if (-1 !== A && this.bits.rewind(32), this.destination && this.destination.render(this.currentY, this.currentCr, this.currentCb, !0), this.pictureType === i.PICTURE_TYPE.INTRA || this.pictureType === i.PICTURE_TYPE.PREDICTIVE) {
                        var t = this.forwardY,
                            e = this.forwardY32,
                            s = this.forwardCr,
                            I = this.forwardCr32,
                            o = this.forwardCb,
                            g = this.forwardCb32;
                        this.forwardY = this.currentY, this.forwardY32 = this.currentY32, this.forwardCr = this.currentCr, this.forwardCr32 = this.currentCr32, this.forwardCb = this.currentCb, this.forwardCb32 = this.currentCb32, this.currentY = t, this.currentY32 = e, this.currentCr = s, this.currentCr32 = I, this.currentCb = o, this.currentCb32 = g
                    }
                }
            }, e.decodeSlice = function(A) {
                for (this.sliceBegin = !0, this.macroblockAddress = (A - 1) * this.mbWidth - 1, this.motionFwH = this.motionFwHPrev = 0, this.motionFwV = this.motionFwVPrev = 0, this.dcPredictorY = 128, this.dcPredictorCr = 128, this.dcPredictorCb = 128, this.quantizerScale = this.bits.read(5); this.bits.read(1);) this.bits.skip(8);
                do {
                    this.decodeMacroblock()
                } while (!this.bits.nextBytesAreStartCode())
            }, e.decodeMacroblock = function() {
                for (var A = 0, t = this.readHuffman(i.MACROBLOCK_ADDRESS_INCREMENT); 34 === t;) t = this.readHuffman(i.MACROBLOCK_ADDRESS_INCREMENT);
                for (; 35 === t;) A += 33, t = this.readHuffman(i.MACROBLOCK_ADDRESS_INCREMENT);
                if (A += t, this.sliceBegin) this.sliceBegin = !1, this.macroblockAddress += A;
                else {
                    if (this.macroblockAddress + A >= this.mbSize) return;
                    for (A > 1 && (this.dcPredictorY = 128, this.dcPredictorCr = 128, this.dcPredictorCb = 128, this.pictureType === i.PICTURE_TYPE.PREDICTIVE && (this.motionFwH = this.motionFwHPrev = 0, this.motionFwV = this.motionFwVPrev = 0)); A > 1;) this.macroblockAddress++, this.mbRow = this.macroblockAddress / this.mbWidth | 0, this.mbCol = this.macroblockAddress % this.mbWidth, this.copyMacroblock(this.motionFwH, this.motionFwV, this.forwardY, this.forwardCr, this.forwardCb), A--;
                ...
                for (var s = 2 & this.macroblockType ? this.readHuffman(i.CODE_BLOCK_PATTERN) : this.macroblockIntra ? 63 : 0, I = 0, o = 32; I < 6; I++) s & o && this.decodeBlock(I), o >>= 1
            }, e.decodeMotionVectors = function() {
                var A, t, e = 0;
                this.macroblockMotFw ? (0 !== (A = this.readHuffman(i.MOTION)) && 1 !== this.forwardF ? (e = this.bits.read(this.forwardRSize), t = (Math.abs(A) - 1 << this.forwardRSize) + e + 1, A < 0 && (t = -t)) : t = A, this.motionFwHPrev += t, this.motionFwHPrev > (this.forwardF << 4) - 1 ? this.motionFwHPrev -= this.forwardF << 5 : this.motionFwHPrev < -this.forwardF << 4 && (this.motionFwHPrev += this.forwardF << 5), this.motionFwH = this.motionFwHPrev, this.fullPelForward && (this.motionFwH <<= 1), 0 !== (A = this.readHuffman(i.MOTION)) && 1 !== this.forwardF ? (e = this.bits.read(this.forwardRSize), t = (Math.abs(A) - 1 << this.forwardRSize) + e + 1, A < 0 && (t = -t)) : t = A, this.motionFwVPrev += t, this.motionFwVPrev > (this.forwardF << 4) - 1 ? this.motionFwVPrev -= this.forwardF << 5 : this.motionFwVPrev < -this.forwardF << 4 && (this.motionFwVPrev += this.forwardF << 5), this.motionFwV = this.motionFwVPrev, this.fullPelForward && (this.motionFwV <<= 1)) : this.pictureType === i.PICTURE_TYPE.PREDICTIVE && (this.motionFwH = this.motionFwHPrev = 0, this.motionFwV = this.motionFwVPrev = 0)
            }, e.copyMacroblock = function(A, t, i, e, s) {
                var I, o, g, a, B, C, Q, E, r, n, h, d, c, l, u, w, D, p, f, m = this.currentY32,
                    y = this.currentCb32,
                    R = this.currentCr32;
                if (o = (I = this.codedWidth) - 16, g = A >> 1, a = t >> 1, B = !(1 & ~A), C = !(1 & ~t), Q = ((this.mbRow << 4) + a) * I + (this.mbCol << 4) + g, r = (E = this.mbRow * I + this.mbCol << 2) + (I << 2), B)
                    if (C)
                        for (; E < r;) {
                            for (h = i[Q] + i[Q + I], Q++, n = 0; n < 4; n++) c = h + (d = i[Q] + i[Q + I]) + 2 >> 2 & 255, c |= (h = i[++Q] + i[Q + I]) + d + 2 << 6 & 65280, c |= h + (d = i[++Q] + i[Q + I]) + 2 << 14 & 16711680, h = i[++Q] + i[Q + I], Q++, c |= h + d + 2 << 22 & 4278190080, m[E++] = c;
                            E += o >> 2, Q += o - 1
                        } else
                            for (; E < r;) {
                                for (h = i[Q++], n = 0; n < 4; n++) c = h + (d = i[Q++]) + 1 >> 1 & 255, c |= (h = i[Q++]) + d + 1 << 7 & 65280, c |= h + (d = i[Q++]) + 1 << 15 & 16711680, c |= (h = i[Q++]) + d + 1 << 23 & 4278190080, m[E++] = c;
                                E += o >> 2, Q += o - 1
                            } else if (C)
                                for (; E < r;) {
                                    for (n = 0; n < 4; n++) c = i[Q] + i[Q + I] + 1 >> 1 & 255, c |= i[++Q] + i[Q + I] + 1 << 7 & 65280, c |= i[++Q] + i[Q + I] + 1 << 15 & 16711680, c |= i[++Q] + i[Q + I] + 1 << 23 & 4278190080, Q++, m[E++] = c;
                                    E += o >> 2, Q += o
                                } else
                                    for (; E < r;) {
                                        for (n = 0; n < 4; n++) c = i[Q], c |= i[++Q] << 8, c |= i[++Q] << 16, c |= i[++Q] << 24, Q++, m[E++] = c;
                                        E += o >> 2, Q += o
                                    }
                if (o = (I = this.halfWidth) - 8, g = A / 2 >> 1, a = t / 2 >> 1, B = 1 == (A / 2 & 1), C = 1 == (t / 2 & 1), Q = ((this.mbRow << 3) + a) * I + (this.mbCol << 3) + g, r = (E = this.mbRow * I + this.mbCol << 1) + (I << 1), B)
                    if (C)
                        for (; E < r;) {
                            for (l = e[Q] + e[Q + I], D = s[Q] + s[Q + I], Q++, n = 0; n < 2; n++) w = l + (u = e[Q] + e[Q + I]) + 2 >> 2 & 255, f = D + (p = s[Q] + s[Q + I]) + 2 >> 2 & 255, w |= (l = e[++Q] + e[Q + I]) + u + 2 << 6 & 65280, f |= (D = s[Q] + s[Q + I]) + p + 2 << 6 & 65280, w |= l + (u = e[++Q] + e[Q + I]) + 2 << 14 & 16711680, f |= D + (p = s[Q] + s[Q + I]) + 2 << 14 & 16711680, l = e[++Q] + e[Q + I], D = s[Q] + s[Q + I], Q++, w |= l + u + 2 << 22 & 4278190080, f |= D + p + 2 << 22 & 4278190080, R[E] = w, y[E] = f, E++;
                            E += o >> 2, Q += o - 1
                        } else
                            for (; E < r;) {
                                for (l = e[Q], D = s[Q], Q++, n = 0; n < 2; n++) w = l + (u = e[Q]) + 1 >> 1 & 255, f = D + (p = s[Q++]) + 1 >> 1 & 255, w |= (l = e[Q]) + u + 1 << 7 & 65280, f |= (D = s[Q++]) + p + 1 << 7 & 65280, w |= l + (u = e[Q]) + 1 << 15 & 16711680, f |= D + (p = s[Q++]) + 1 << 15 & 16711680, w |= (l = e[Q]) + u + 1 << 23 & 4278190080, f |= (D = s[Q++]) + p + 1 << 23 & 4278190080, R[E] = w, y[E] = f, E++;
                                E += o >> 2, Q += o - 1
                            } else if (C)
                                for (; E < r;) {
                                    for (n = 0; n < 2; n++) w = e[Q] + e[Q + I] + 1 >> 1 & 255, f = s[Q] + s[Q + I] + 1 >> 1 & 255, w |= e[++Q] + e[Q + I] + 1 << 7 & 65280, f |= s[Q] + s[Q + I] + 1 << 7 & 65280, w |= e[++Q] + e[Q + I] + 1 << 15 & 16711680, f |= s[Q] + s[Q + I] + 1 << 15 & 16711680, w |= e[++Q] + e[Q + I] + 1 << 23 & 4278190080, f |= s[Q] + s[Q + I] + 1 << 23 & 4278190080, Q++, R[E] = w, y[E] = f, E++;
                                    E += o >> 2, Q += o
                                } else
                                    for (; E < r;) {
                                        for (n = 0; n < 2; n++) w = e[Q], f = s[Q], w |= e[++Q] << 8, f |= s[Q] << 8, w |= e[++Q] << 16, f |= s[Q] << 16, w |= e[++Q] << 24, f |= s[Q] << 24, Q++, R[E] = w, y[E] = f, E++;
                                        E += o >> 2, Q += o
                                    }
    ...
    var D = function(A) {
            function i(t) {
                var i;
                return (i = A.call(this, t) || this).onDecodeCallback = t.onVideoDecode, i.module = t.wasmModule, i.bufferSize = t.videoBufferSize || 524288, i.bufferMode = t.streaming ? c.MODE.EVICT : c.MODE.EXPAND, i.decodeFirstFrame = !1 !== t.decodeFirstFrame, i.hasSequenceHeader = !1, i
            }
            t(i, A);
            var e = i.prototype;
            return e.initializeWasmDecoder = function() {
                this.module.instance && (this.instance = this.module.instance, this.functions = this.module.instance.exports, this.decoder = this.functions._mpeg1_decoder_create(this.bufferSize, this.bufferMode))
            }, e.destroy = function() {
                this.decoder && this.functions._mpeg1_decoder_destroy(this.decoder)
            }, e.bufferGetIndex = function() {
                if (this.decoder) return this.functions._mpeg1_decoder_get_index(this.decoder)
                ...
                for (var e = this.functions._mpeg1_decoder_get_write_ptr(this.decoder, t), s = 0; s < A.length; s++) this.instance.heapU8.set(A[s], e), e += A[s].length;
                return this.functions._mpeg1_decoder_did_write(this.decoder, t), t
            }, e.write = function(A, t) {
                u.prototype.write.call(this, A, t), !this.hasSequenceHeader && this.functions._mpeg1_decoder_has_sequence_header(this.decoder) && this.loadSequenceHeader()
            }, e.loadSequenceHeader = function() {
                if (this.hasSequenceHeader = !0, this.frameRate = this.functions._mpeg1_decoder_get_frame_rate(this.decoder), this.codedSize = this.functions._mpeg1_decoder_get_coded_size(this.decoder), this.destination) {
        ...
        p = function(A) {
            function i(t) {
                ...
                e.bits = new c(s, I), e.left = new Float32Array(1152), e.right = new Float32Array(1152), e.sampleRate = 44100, e.D = new Float32Array(1024), e.D.set(i.SYNTHESIS_WINDOW, 0), e.D.set(i.SYNTHESIS_WINDOW, 512), e.V = [new Float32Array(1024), new Float32Array(1024)], e.U = new Int32Array(32), e.VPos = 0, e.allocation = [new Array(32), new Array(32)], e.scaleFactorInfo = [new Uint8Array(32), new Uint8Array(32)], e.scaleFactor = [new Array(32), new Array(32)], e.sample = [new Array(32), new Array(32)];
                for (var o = 0; o < 2; o++)
                    for (var g = 0; g < 32; g++) e.scaleFactor[o][g] = [0, 0, 0], e.sample[o][g] = [0, 0, 0];
                return e
            }
            t(i, A);
            var e = i.prototype;
            return e.decode = function() {
                ...
                this.destination && this.destination.play(this.sampleRate, this.left, this.right), this.advanceDecodedTime(this.left.length / this.sampleRate);
                var e = Q() - A;
                ...
                var e = this.bits.read(11),
                    ...
                    I = this.bits.read(2),
                    o = !this.bits.read(1);
                if (e !== i.FRAME_SYNC || s !== i.VERSION.MPEG_1 || I !== i.LAYER.II) return 0;
                ...
                var Q = this.bits.read(2),
                    r = 0;
                Q === i.MODE.JOINT_STEREO ? r = this.bits.read(2) + 1 << 2 : (this.bits.skip(2), r = Q === i.MODE.MONO ? 0 : 32), this.bits.skip(4), o && this.bits.skip(16);
                ...
                r > d && (r = d);
                for (var u = 0; u < r; u++) this.allocation[0][u] = this.readAllocation(u, h), this.allocation[1][u] = this.readAllocation(u, h);
                for (var w = r; w < d; w++) this.allocation[0][w] = this.allocation[1][w] = this.readAllocation(w, h);
                for (var D = Q === i.MODE.MONO ? 1 : 2, p = 0; p < d; p++) {
                    for (var f = 0; f < D; f++) this.allocation[f][p] && (this.scaleFactorInfo[f][p] = this.bits.read(2));
                    ...
                    for (var y = 0; y < D; y++)
                        if (this.allocation[y][m]) {
                            ...
                            switch (this.scaleFactorInfo[y][m]) {
                                case 0:
                                    R[0] = this.bits.read(6), R[1] = this.bits.read(6), R[2] = this.bits.read(6);
                                    break;
                                case 1:
                                    R[0] = R[1] = this.bits.read(6), R[2] = this.bits.read(6);
                                    break;
                                case 2:
                                    R[0] = R[1] = R[2] = this.bits.read(6);
                                    break;
                                case 3:
                                    R[0] = this.bits.read(6), R[1] = R[2] = this.bits.read(6)
                            }
                        } Q === i.MODE.MONO && (this.scaleFactor[1][m][0] = this.scaleFactor[0][m][0], this.scaleFactor[1][m][1] = this.scaleFactor[0][m][1], this.scaleFactor[1][m][2] = this.scaleFactor[0][m][2])
                }
                for (var k = 0, b = 0; b < 3; b++)
                    for (var G = 0; G < 4; G++) {
                        for (var F = 0; F < r; F++) this.readSamples(0, F, b), this.readSamples(1, F, b);
                        for (var S = r; S < d; S++) this.readSamples(0, S, b), this.sample[1][S][0] = this.sample[0][S][0], this.sample[1][S][1] = this.sample[0][S][1], this.sample[1][S][2] = this.sample[0][S][2];
                        for (var M = d; M < 32; M++) this.sample[0][M][0] = 0, this.sample[0][M][1] = 0, this.sample[0][M][2] = 0, this.sample[1][M][0] = 0, this.sample[1][M][1] = 0, this.sample[1][M][2] = 0;
                        for (var q = 0; q < 3; q++) {
                            this.VPos = this.VPos - 64 & 1023;
                            for (var N = 0; N < 2; N++) {
                                i.MatrixTransform(this.sample[N], q, this.V[N], this.VPos), E(this.U, 0);
                                for (var L = 512 - (this.VPos >> 1), U = this.VPos % 128 >> 1; U < 1024;) {
                                    for (var J = 0; J < 32; ++J) this.U[J] += this.D[L++] * this.V[N][U++];
                                    U += 96, L += 32
                                }
                                for (U = 1120 - U, L -= 480; U < 1024;) {
                                    for (var T = 0; T < 32; ++T) this.U[T] += this.D[L++] * this.V[N][U++];
                                    U += 96, L += 32
                                }
                                for (var v = 0 === N ? A : t, x = 0; x < 32; x++) v[k + x] = this.U[x] / 2147418112
                            }
                            k += 32
                        }
                    }
    ...
    var f = function(A) {
        function i(t) {
            var i;
            return (i = A.call(this, t) || this).onDecodeCallback = t.onAudioDecode, i.module = t.wasmModule, i.bufferSize = t.audioBufferSize || 131072, i.bufferMode = t.streaming ? c.MODE.EVICT : c.MODE.EXPAND, i.sampleRate = 0, i
        }
        t(i, A);
        var e = i.prototype;
        return e.initializeWasmDecoder = function() {
            this.module.instance && (this.instance = this.module.instance, this.functions = this.module.instance.exports, this.decoder = this.functions._mp2_decoder_create(this.bufferSize, this.bufferMode))
        }, e.destroy = function() {
            this.decoder && this.functions._mp2_decoder_destroy(this.decoder)
        }, e.bufferGetIndex = function() {
            if (this.decoder) return this.functions._mp2_decoder_get_index(this.decoder)
        }, e.bufferSetIndex = function(A) {
            this.decoder && this.functions._mp2_decoder_set_index(this.decoder, A)
        }, e.bufferWrite = function(A) {
            this.decoder || this.initializeWasmDecoder();
            for (var t = 0, i = 0; i < A.length; i++) t += A[i].length;
            for (var e = this.functions._mp2_decoder_get_write_ptr(this.decoder, t), s = 0; s < A.length; s++) this.instance.heapU8.set(A[s], e), e += A[s].length;
            ...
            if (this.sampleRate || (this.sampleRate = this.functions._mp2_decoder_get_sample_rate(this.decoder)), this.destination) {
    ...
    var m = function() {
        function A(A) {
            A.canvas ? (this.canvas = A.canvas, this.ownsCanvasElement = !1) : (this.canvas = document.createElement("canvas"), this.ownsCanvasElement = !0), this.width = this.canvas.width, this.height = this.canvas.height, this.enabled = !0, this.hasTextureData = {};
            var t = {
        ...
        return t.initGL = function() {
            ...
            var A = this.gl;
            this.deleteTexture(A.TEXTURE0, this.textureY), this.deleteTexture(A.TEXTURE1, this.textureCb), this.deleteTexture(A.TEXTURE2, this.textureCr), A.useProgram(null), A.deleteProgram(this.program), A.deleteProgram(this.loadingProgram), A.bindBuffer(A.ARRAY_BUFFER, null), A.deleteBuffer(this.vertexBuffer), this.canvas.removeEventListener("webglcontextlost", this.handleContextLostBound, !1), this.canvas.removeEventListener("webglcontextrestored", this.handleContextRestoredBound, !1), this.ownsCanvasElement && this.canvas.remove()
        }, t.resize = function(A, t) {
            this.width = 0 | A, this.height = 0 | t, this.canvas.width = this.width, this.canvas.height = this.height, this.gl.useProgram(this.program);
            var i = this.width + 15 >> 4 << 4;
            this.gl.viewport(0, 0, i, this.height)
        }, t.createTexture = function(A, t) {
            var i = this.gl,
                e = i.createTexture();
            return i.bindTexture(i.TEXTURE_2D, e), i.texParameteri(i.TEXTURE_2D, i.TEXTURE_MAG_FILTER, i.LINEAR), i.texParameteri(i.TEXTURE_2D, i.TEXTURE_MIN_FILTER, i.LINEAR), i.texParameteri(i.TEXTURE_2D, i.TEXTURE_WRAP_S, i.CLAMP_TO_EDGE), i.texParameteri(i.TEXTURE_2D, i.TEXTURE_WRAP_T, i.CLAMP_TO_EDGE), i.uniform1i(i.getUniformLocation(this.program, t), A), e
        }, t.createProgram = function(A, t) {
            var i = this.gl,
                e = i.createProgram();
            return i.attachShader(e, this.compileShader(i.VERTEX_SHADER, A)), i.attachShader(e, this.compileShader(i.FRAGMENT_SHADER, t)), i.linkProgram(e), i.useProgram(e), e
        }, t.compileShader = function(A, t) {
            var i = this.gl,
                e = i.createShader(A);
            if (i.shaderSource(e, t), i.compileShader(e), !i.getShaderParameter(e, i.COMPILE_STATUS)) throw new Error(i.getShaderInfoLog(e));
            return e
        }, t.allowsClampedTextureData = function() {
            var A = this.gl,
                t = A.createTexture();
            return A.bindTexture(A.TEXTURE_2D, t), A.texImage2D(A.TEXTURE_2D, 0, A.LUMINANCE, 1, 1, 0, A.LUMINANCE, A.UNSIGNED_BYTE, new Uint8ClampedArray([0])), 0 === A.getError()
            ...
            if (this.enabled) {
                var s = this.gl,
                    ...
                    g = I >> 1,
                    a = o >> 1;
                e && this.shouldCreateUnclampedViews && (A = new Uint8Array(A.buffer), t = new Uint8Array(t.buffer), i = new Uint8Array(i.buffer)), s.useProgram(this.program), this.updateTexture(s.TEXTURE0, this.textureY, I, o, A), this.updateTexture(s.TEXTURE1, this.textureCb, g, a, t), this.updateTexture(s.TEXTURE2, this.textureCr, g, a, i), s.drawArrays(s.TRIANGLE_STRIP, 0, 4)
            }
        }, t.updateTexture = function(A, t, i, e, s) {
            var I = this.gl;
            I.activeTexture(A), I.bindTexture(I.TEXTURE_2D, t), this.hasTextureData[A] ? I.texSubImage2D(I.TEXTURE_2D, 0, 0, 0, i, e, I.LUMINANCE, I.UNSIGNED_BYTE, s) : (this.hasTextureData[A] = !0, I.texImage2D(I.TEXTURE_2D, 0, I.LUMINANCE, i, e, 0, I.LUMINANCE, I.UNSIGNED_BYTE, s))
        }, t.deleteTexture = function(A, t) {
            var i = this.gl;
            i.activeTexture(A), i.bindTexture(i.TEXTURE_2D, null), i.deleteTexture(t)
    ...
    var y = function() {
            function A(A) {
                A.canvas ? (this.canvas = A.canvas, this.ownsCanvasElement = !1) : (this.canvas = document.createElement("canvas"), this.ownsCanvasElement = !0), this.width = this.canvas.width, this.height = this.canvas.height, this.enabled = !0, this.context = this.canvas.getContext("2d")
            }
            var t = A.prototype;
            return t.destroy = function() {
                this.ownsCanvasElement && this.canvas.remove()
            }, t.resize = function(A, t) {
                this.width = 0 | A, this.height = 0 | t, this.canvas.width = this.width, this.canvas.height = this.height, this.imageData = this.context.getImageData(0, 0, this.width, this.height), E(this.imageData.data, 255)
            }, t.renderProgress = function(A) {
                var t = this.canvas.width,
                    i = this.canvas.height,
                    e = this.context;
                e.fillStyle = "#222", e.fillRect(0, 0, t, i), e.fillStyle = "#fff", e.fillRect(0, i - i * A, t, i * A)
            }, t.render = function(A, t, i) {
                this.YCbCrToRGBA(A, t, i, this.imageData.data), this.context.putImageData(this.imageData, 0, 0)
            }, t.YCbCrToRGBA = function(A, t, i, e) {
                if (this.enabled)
                    for (var s, I, o, g, a, B = this.width + 15 >> 4 << 4, C = B >> 1, Q = 0, E = B, r = B + (B - this.width), n = 0, h = C - (this.width >> 1), d = 0, c = 4 * this.width, l = 4 * this.width, u = this.width >> 1, w = this.height >> 1, D = 0; D < w; D++) {
                        for (var p = 0; p < u; p++) {
                            s = t[n], I = i[n], n++, o = s + (103 * s >> 8) - 179, g = (88 * I >> 8) - 44 + (183 * s >> 8) - 91, a = I + (198 * I >> 8) - 227;
                            var f = A[Q++],
                                m = A[Q++];
                            e[d] = f + o, e[d + 1] = f - g, e[d + 2] = f + a, e[d + 4] = m + o, e[d + 5] = m - g, e[d + 6] = m + a, d += 8;
                            var y = A[E++],
                                R = A[E++];
                            e[c] = y + o, e[c + 1] = y - g, e[c + 2] = y + a, e[c + 4] = R + o, e[c + 5] = R - g, e[c + 6] = R + a, c += 8
                        }
                        Q += r, E += r, d += l, c += l, n += h
                    }
            }, A
        ...
        R = function() {
            function A() {
                this.context = A.CachedContext = A.CachedContext || new(window.AudioContext || window.webkitAudioContext), this.gain = this.context.createGain(), this.destination = this.gain, this.gain.connect(this.context.destination), this.context._connections = (this.context._connections || 0) + 1, this.startTime = 0, this.buffer = null, this.wallclockStartTime = 0, this.volume = 1, this.enabled = !0, this.unlocked = !A.NeedsUnlocking(), Object.defineProperty(this, "enqueuedTime", {
                    get: this.getEnqueuedTime
                })
            }
            var t = A.prototype;
            return t.destroy = function() {
                this.gain.disconnect(), this.context._connections--, 0 === this.context._connections && (this.context.close(), A.CachedContext = null)
            }, t.play = function(A, t, i) {
                if (this.enabled) {
                    if (!this.unlocked) {
                        var e = Q();
                        return this.wallclockStartTime < e && (this.wallclockStartTime = e), void(this.wallclockStartTime += t.length / A)
                    }
                    ...
                    var o = this.context.currentTime,
                        g = s.duration;
                    this.startTime < o && (this.startTime = o, this.wallclockStartTime = Q()), I.start(this.startTime), this.startTime += g, this.wallclockStartTime += g
                }
            }, t.stop = function() {
                ...
                this.startTime = this.context.currentTime, this.wallclockStartTime = Q()
            }, t.unlock = function(A) {
                if (this.unlocked) A && A();
                    ...
                    i.buffer = t, i.connect(this.destination), i.start ? i.start(0) : i.noteOn(0), setTimeout(this.checkIfUnlocked.bind(this, i, 0), 0)
                }
            }, t.checkIfUnlocked = function(A, t) {
                A.playbackState === A.PLAYING_STATE || A.playbackState === A.FINISHED_STATE ? (this.unlocked = !0, this.unlockCallback && (this.unlockCallback(), this.unlockCallback = null)) : t < 10 && setTimeout(this.checkIfUnlocked.bind(this, A, t + 1), 100)
    ...
    var k = function() {
            function A() {
                this.stackSize = 5242880, this.pageSize = 65536, this.onInitCallbacks = [], this.ready = !1, this.loadingFromFileStarted = !1, this.loadingFromBufferStarted = !1
            }
            var t = A.prototype;
            return t.write = function(A) {
                this.loadFromBuffer(A)
            }, t.loadFromFile = function(A, t) {
                if (t && this.onInitCallbacks.push(t), !this.loadingFromFileStarted) {
                ...
                var i = this;
                if (t && this.onInitCallbacks.push(t), !this.loadingFromBufferStarted)
                    if (this.loadingFromBufferStarted = !0, this.moduleInfo = this.readDylinkSection(A), this.moduleInfo) {
                        ...
                        this.brk = this.align(this.moduleInfo.memorySize + this.stackSize), WebAssembly.instantiate(A, {
                            env: e
                        }).then((function(A) {
                            i.instance = A.instance, i.instance.exports.__post_instantiate && i.instance.exports.__post_instantiate(), i.createHeapViews(), i.ready = !0;
                            for (var t = 0; t < i.onInitCallbacks.length; t++) i.onInitCallbacks[t](i)
                        }))
                    } else
                        for (var s = 0; s < this.onInitCallbacks.length; s++) this.onInitCallbacks[s](null)
            }, t.createHeapViews = function() {
                this.instance.heapU8 = new Uint8Array(this.memory.buffer), this.instance.heapU32 = new Uint32Array(this.memory.buffer), this.instance.heapF32 = new Float32Array(this.memory.buffer)
            }, t.align = function(A) {
                ...
                return t
            }, t.c_abort = function(A) {}, t.c_assertFail = function(A) {}, t.readDylinkSection = function(A) {
                var t = new Uint8Array(A),
                    i = 0,
                    e = function() {
                        for (var A = 0, e = 1;;) {
                ...
                return s([0, "a", "s", "m"]) ? (i = 9, e(), s([6, "d", "y", "l", "i", "n", "k"]) ? {
                    memorySize: e(),
                    memoryAlignment: e(),
                    tableSize: e(),
                    tableAlignment: e()
        ...
        G = function() {
            ...
            return t.startLoading = function() {
                ...
                this.animationId || (this.animationId = requestAnimationFrame(this.update.bind(this)), this.wantsToPlay = !0, this.paused = !1)
            }, t.pause = function() {
                this.paused || (cancelAnimationFrame(this.animationId), this.animationId = null, this.wantsToPlay = !1, this.isPlaying = !1, this.paused = !0, this.audio && this.audio.canPlay && (this.audioOut.stop(), this.seek(this.currentTime)), this.hooks.pause && this.hooks.pause(), this.options.onPause && this.options.onPause(this))
            }, t.getVolume = function() {
                return this.audioOut ? this.audioOut.volume : 0
            }, t.setVolume = function(A) {
                this.audioOut && (this.audioOut.volume = A)
            }, t.stop = function() {
                this.pause(), this.seek(0), this.video && !1 !== this.options.decodeFirstFrame && this.video.decode(), this.hooks.stop && this.hooks.stop()
            }, t.destroy = function() {
                this.pause(), this.source.destroy(), this.video && this.video.destroy(), this.renderer && this.renderer.destroy(), this.audio && this.audio.destroy(), this.audioOut && this.audioOut.destroy()
            }, t.seek = function(A) {
                var t = this.audio && this.audio.canPlay ? this.audio.startTime : this.video.startTime;
                this.video && this.video.seek(A + t), this.audio && this.audio.seek(A + t), this.startTime = Q() - A
            }, t.getCurrentTime = function() {
                ...
                this.animationId = requestAnimationFrame(this.update.bind(this)), this.source.established ? (this.isPlaying || (this.isPlaying = !0, this.startTime = Q() - this.currentTime, this.hooks.play && this.hooks.play(), this.options.onPlay && this.options.onPlay(this)), this.options.streaming ? this.updateForStreaming() : this.updateForStaticFile()) : this.renderer && this.renderer.renderProgress(this.source.progress)
                ...
                if (!this.streamStartTime) {
                    ...
                    this.totalAudioDecoded = 0;
                    this.totalVideoDecoded = 0;
                }
                ...
                if (this.audio && this.audio.canPlay && this.video) {
                    ...
                    // === AUDIO DECODE ===
                    // Audio buffer'ı hedef seviyeye kadar doldur
                    var audioDecoded = 0;
                    while (this.audioOut.enqueuedTime < targetBuf && audioDecoded < 20) {
                        var prevTime = this.audio.decodedTime;
                        if (!this.audio.decode()) break;
                        var decoded = this.audio.decodedTime - prevTime;
                        if (decoded > 0) this.totalAudioDecoded += decoded;
                        audioDecoded++;
                    }
                    
                    // Audio oynatma zamanı (gerçek oynatılan)
                    var audioPlayTime = this.totalAudioDecoded - this.audioOut.enqueuedTime;
                    
                    // === VIDEO DECODE ===
                    // Video, AUDIO'YU takip etsin (audio master)
                    // Video hedefi = audioPlayTime (± tolerans)
                    var drift = audioPlayTime - this.totalVideoDecoded;
                    var maxFramesPerUpdate = 5;
                    var framesDecoded = 0;
                    
                    if (drift > 0.1) {
                        // Audio önde - video yakalaşsın
                        var framesToCatch = Math.min(Math.ceil(drift / frameTime), maxFramesPerUpdate);
                        while (framesDecoded < framesToCatch) {
                            var prevVidTime = this.video.currentTime;
                            if (!this.video.decode()) break;
                            var decodedVid = this.video.currentTime - prevVidTime;
                            this.totalVideoDecoded += (decodedVid > 0) ? decodedVid : frameTime;
                            framesDecoded++;
                        }
                    } else if (drift < -0.1) {
                        // Video önde - video dursun (decode etme)
                        // Audio yakalaşana kadar bekle
                    } else {
                        // Sync OK - normal 1 frame decode et
                        var prevVidTime = this.video.currentTime;
                        if (this.video.decode()) {
                            var decodedVid = this.video.currentTime - prevVidTime;
                            this.totalVideoDecoded += (decodedVid > 0) ? decodedVid : frameTime;
                        }
                    }
                    
                } else if (this.audio && this.audio.canPlay) {
                    var targetBuf2 = this.options.targetAudioBuffer || 0.5;
                    while (this.audioOut.enqueuedTime < targetBuf2) { if (!this.audio.decode()) break; }
                } else if (this.video) {
                    var frameTime2 = 1 / (this.video.frameRate || 25);
                    if (!this.streamStartTime) this.streamStartTime = now;
                    if (!this.totalVideoDecoded) this.totalVideoDecoded = 0;
                    var realElapsed = now - this.streamStartTime;
                    if (this.totalVideoDecoded < realElapsed) {
                        this.video.decode();
                        this.totalVideoDecoded += frameTime2;
                    }
                }
                ...
                if (this.audio && this.audio.canPlay) {
                    for (; !A && this.audio.decodedTime - this.audio.currentTime < .25;) A = !this.audio.decode();
                    this.video && this.video.currentTime < this.audio.currentTime && (A = !this.video.decode()), t = this.demuxer.currentTime - this.audio.currentTime
                } else if (this.video) {
                    var i = Q() - this.startTime + this.video.startTime,
                        e = i - this.video.currentTime,
                        s = 1 / this.video.frameRate;
                    this.video && e > 0 && (e > 2 * s && (this.startTime += e), A = !this.video.decode()), t = this.demuxer.currentTime - i
                }
                this.source.resume(t), A && this.source.completed ? this.loop ? this.seek(0) : (this.stop(), this.options.onEnded && this.options.onEnded(this)) : A && this.options.onStalled && this.options.onStalled(this)
            }, A
        }();
    return {
        Player: G,
        ...
        Source: {
            ...
            Fetch: function() {
                function A(A, t) {
                    this.url = A, this.destination = null, this.request = null, this.streaming = !0, this.completed = !1, this.established = !1, this.progress = 0, this.aborted = !1, this.onEstablishedCallback = t.onSourceEstablished, this.onCompletedCallback = t.onSourceCompleted, t.hookOnEstablished && (this.hookOnEstablished = t.hookOnEstablished)
                }
                var t = A.prototype;
                return t.connect = function(A) {
                    this.destination = A
                    ...
                    self.fetch(this.url, t).then((function(t) {
                        if (t.ok && t.status >= 200 && t.status <= 299) return A.progress = 1, A.established = !0, A.pump(t.body.getReader())
                    })).catch((function(A) {
                        throw A
                    }))
                }, t.pump = function(A) {
                    ...
                    return A.read().then((function(i) {
                        if (!i.done) return t.aborted ? A.cancel() : (t.destination && t.destination.write(i.value.buffer), t.pump(A));
                        t.completed = !0
                    })).catch((function(A) {
                        throw A
                    }))
                }, t.resume = function() {}, t.abort = function() {
                    this.aborted = !0
                }, A
            }()
        },
        ...
        CreateVideoElements: function() {
            for (var A = document.querySelectorAll(".jsmpeg"), t = 0; t < A.length; t++) new C(A[t])
        },
        Fill: E,
