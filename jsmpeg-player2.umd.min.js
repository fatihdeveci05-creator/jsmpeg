        ...
        G = function() {
            ...
            return t.startLoading = function() {
                ...
                if (this.audio && this.audio.canPlay && this.video) {
                    var targetBuf = this.options.targetAudioBuffer || 0.3;
                    var maxDrift = this.options.maxSyncDrift || 0.08;
                    var hardLimit = this.options.hardSyncLimit || 0.25;
                    ...
                    if (drift > maxDrift) {
                        ...
                        var skipFrames = Math.min(Math.ceil(-drift / frameTime), 3);
                        for (var k = 0; k < skipFrames; k++) { if (!this.video.decode()) break; }
                    } else {
                        this.video.decode();
                    }
