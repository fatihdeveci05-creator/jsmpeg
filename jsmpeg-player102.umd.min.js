        ...
        G = function() {
            ...
            return t.startLoading = function() {
                ...
                if (this.audio && this.audio.canPlay && this.video) {
                    ...
                    var hardLimit = this.options.hardSyncLimit || 0.05; /*0.5 olan sayý 0.05 oldu*/
                    var frameRate = 20;
                    ...
                    var decoded = 0;
                    while (this.audioOut.enqueuedTime < targetBuf && decoded < 3) {
                        if (!this.audio.decode()) break;
                        decoded++;
                    }
                    // updateForStreaming içine ekle
if (this.debugCounter === undefined) {
    this.debugCounter = 0;
    this.debugStartTime = performance.now();
    this.debugStartAudioTime = 0;
}

this.debugCounter++;
if (this.debugCounter % 300 === 0) { // Her 10 saniyede bir (30fps * 10)
    var elapsed = (performance.now() - this.debugStartTime) / 1000;
    ...
    console.log('Audio decoded:', this.audio.decodedTime.toFixed(3));
    console.log('Audio enqueued:', this.audioOut.enqueuedTime.toFixed(3));
    console.log('Audio effective:', audioTime.toFixed(3));
    console.log('Drift:', (audioTime - videoTime).toFixed(3));
    console.log('AudioContext sampleRate:', this.audioOut.context ? this.audioOut.context.sampleRate : 'N/A');
    console.log('==================');
}
                    var audioTime = this.audio.decodedTime - this.audioOut.enqueuedTime;
                    var videoTime = this.video.currentTime;
            ...
            }, t.updateForStaticFile = function() {//DECODE YAPILAN STATÝC FÝLE
                var A = !1,
                    t = 0;
